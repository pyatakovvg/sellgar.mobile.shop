...
export const textStatus = (theme: ColorSchemeName) => {
  ...
  return {
    ...
    success_secondary: isLight ? positivePalette.green_8a : positivePalette.green_8a,
    success_tertiary: isLight ? positivePalette.green_5a : positivePalette.green_6a,
    ...
    warning_tertiary: isLight ? warningPalette.orange_5a : warningPalette.orange_6a,
    ...
    info_tertiary: isLight ? informativePalette.blue_5a : informativePalette.blue_6a,
  };
};
