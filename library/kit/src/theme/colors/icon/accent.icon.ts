...
export const accentIcon = (theme: ColorSchemeName) => {
  ...
  return {
    ...
    orange: isLight ? warningPalette.orange_11 : warningPalette.orange_11,
    ...
    red: isLight ? negativePalette.red_11 : negativePalette.red_11,
    ...
    purple: isLight ? brandPalette.purple_11 : brandPalette.purple_11,
